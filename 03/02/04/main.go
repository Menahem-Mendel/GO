...
// Сервер должен использовать в ответе заголовок ContentType наподобие следующего w.Header.Set("ContentType", "image/svg+xml").
// Этот шаг не был нужен в примере с фигурами Лиссажу,
// так как сервер использует стандартную эвристику распознавания распространенных форматов наподобие PNG по первым 512 байтам ответа
// и генерирует корректный заголовок.
